...
class PyMySQL(object):
    ...
    def _connect(self):
        self.conn = MySQLdb.connect(host=self.host, port=self.post, user=self.username, passwd=self.password,
    ...
    def get_select_sql(self, table_name, fields, where):
        ...
        if not isinstance(fields, basestring) or not isinstance(table_name, basestring) or not isinstance(where,
                                                                                                          basestring):
            return None
    ...
    def get_insert_sql(self, table_name, fields, values, isnone):
        ...
        if not isinstance(table_name, basestring) or not isinstance(fields, basestring) or not isinstance(values,
                                                                                                          basestring):
            return None
    ...
    def get_update_sql(self, table_name, where, values, isnone=False):
        ...
        if not isinstance(table_name, basestring) or not isinstance(values, basestring) or not isinstance(where,
                                                                                                          basestring):
            return None
    ...
    def get_create_sql(self, table_name, fields):
        ...
        create_sql = "CREATE TABLE `%s`(%s)ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci" % (
